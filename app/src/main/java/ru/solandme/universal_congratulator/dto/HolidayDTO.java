package ru.solandme.universal_congratulator.dto;
...
public class HolidayDTO {
    ...
    public HolidayDTO(String displayHolidayName) {
        this.displayHolidayName = displayHolidayName;
    }

    public HolidayDTO(String key, String displayHolidayName, int pictureId, int filter, String description) {
        this.key = key;
        this.displayHolidayName = displayHolidayName;
    ...
    public HolidayDTO(String key, String displayHolidayName, int pictureId, int filter, String description, int day, int month, String daysToHoliday) {
        this.key = key;
        this.displayHolidayName = displayHolidayName;
        this.pictureId = pictureId;
        this.filter = filter;
